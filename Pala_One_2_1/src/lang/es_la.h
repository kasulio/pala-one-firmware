...
#define D_WEB_UPLOAD_BOOK_DESC      "Envíe archivos UTF-8 .txt o .md a <b>/books</b> en el dispositivo, luego organícelos en carpetas desde la página Archivos."
...
#define D_WEB_NOTES_DESC            "Los libros subidos se normalizan y compactan antes de guardarse, por lo que un archivo de origen puede ser más grande que el archivo final almacenado. El marcado Markdown (.md) se muestra en Helvetica con lectura biónica desactivada. El lector está optimizado para texto UTF-8 e idiomas con alfabeto latino."
...
#define D_WEB_BOOK_FORMAT_MD        " &middot; Markdown"
#define D_WEB_BOOK_FORMAT_TXT       " &middot; texto plano"
...
#define D_WEB_TREAT_AS_MD_BUTTON    "Tratar como Markdown"
#define D_WEB_TREAT_AS_TXT_BUTTON   "Tratar como texto plano"
...
#define D_WEB_ERR_MISSING_ID_FORMAT     "id/formato faltante"
#define D_WEB_ERR_BAD_FORMAT            "formato inválido"
#define D_WEB_ERR_FORMAT_FAILED         "fallo al cambiar formato"
