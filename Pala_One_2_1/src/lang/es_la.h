...
// ----------------------------------------------------------------------------
//  Notes screens (picker / read / edit)
// ----------------------------------------------------------------------------
#define D_NOTES_PICKER_HEADER       "Notas"
#define D_NOTES_PICKER_NEW          "+ Nueva nota"
#define D_NOTES_READ_HEADER         "Nota"
#define D_NOTES_READ_MENU_TITLE     "Nota"
#define D_NOTES_MENU_EDIT           "Editar"
#define D_NOTES_MENU_BT_OFF         "Teclado: apagado"
#define D_NOTES_MENU_BT_SCAN        "Teclado: buscando"
#define D_NOTES_MENU_BT_CONNECT     "Teclado: conectando"
#define D_NOTES_MENU_BT_OK          "Teclado: conectado"
#define D_NOTES_MENU_BT_FAIL        "Teclado: no conectado"
#define D_NOTES_EDIT_TOO_LARGE      "No editable aqui (>6k)"
#define D_NOTES_REMOVE_ALL          "Quitar teclados"
#define D_NOTES_REMOVE_CONFIRM      "2x: confirmar quitar"
#define D_NOTES_LAYOUT_HEADER       "Distribucion teclado"
#define D_NOTES_LAYOUT_US           "US QWERTY"
#define D_NOTES_LAYOUT_UK           "UK QWERTY"
#define D_NOTES_LAYOUT_DE           "Aleman QWERTZ"
#define D_NOTES_LAYOUT_FR           "Frances AZERTY"
...
#define D_NOTES_BLE_FORGET          "Borrar emparejamientos"
#define D_NOTES_BLE_CONNECTING      " (conectando...)"
#define D_NOTES_BLE_MENU_CONNECT    "2x: conectar"
#define D_NOTES_BLE_SEARCHING       "Buscando teclados..."
...
#define D_NOTES_ACTION_CANCEL       "2x: cancelar  Mant: salir"
#define D_NOTES_CONNECT_WAKE        "Despierte teclado, mismo BT"
