...
// ----------------------------------------------------------------------------
#define D_NOTES_PICKER_HEADER       "Notes"
#define D_NOTES_PICKER_NEW          "+ New note"
#define D_NOTES_READ_HEADER         "Note"
#define D_NOTES_READ_MENU_TITLE     "Note"
#define D_NOTES_MENU_EDIT           "Edit"
#define D_NOTES_MENU_BT_OFF         "Keyboard: off"
#define D_NOTES_MENU_BT_SCAN        "Keyboard: scanning"
#define D_NOTES_MENU_BT_CONNECT     "Keyboard: connecting"
#define D_NOTES_MENU_BT_OK          "Keyboard: connected"
#define D_NOTES_MENU_BT_FAIL        "Keyboard: not connected"
#define D_NOTES_EDIT_TOO_LARGE      "Cannot edit on device (>6k)"
#define D_NOTES_REMOVE_ALL          "Remove all keyboards"
#define D_NOTES_REMOVE_CONFIRM      "2x: confirm remove all"
#define D_NOTES_LAYOUT_HEADER       "Keyboard layout"
#define D_NOTES_LAYOUT_US           "US QWERTY"
#define D_NOTES_LAYOUT_UK           "UK QWERTY"
#define D_NOTES_LAYOUT_DE           "German QWERTZ"
#define D_NOTES_LAYOUT_FR           "French AZERTY"
...
#define D_NOTES_BLE_FORGET          "Clear pairings"
#define D_NOTES_BLE_CONNECTING      " (connecting...)"
#define D_NOTES_BLE_MENU_CONNECT    "2x: connect"
#define D_NOTES_BLE_SEARCHING       "Searching for keyboards..."
...
#define D_NOTES_ACTION_CANCEL       "2x: cancel  Hold: exit"
#define D_NOTES_CONNECT_WAKE        "Wake keyboard, same BT slot"
