...
#define D_WEB_UPLOAD_BOOK_DESC      "Send UTF-8 .txt or .md files to <b>/books</b> on the device, then sort them into folders from the Files page."
...
#define D_WEB_NOTES_DESC            "Uploaded books are normalized and compacted before saving, so a source file can be larger than the final stored file. Markdown (.md) markup is rendered in Helvetica with bionic reading off. The reader is optimized for UTF-8 text and Latin-based languages."
...
#define D_WEB_BOOK_FORMAT_TXT       " &middot; plain text"
...
#define D_WEB_TREAT_AS_MD_BUTTON    "Treat as Markdown"
#define D_WEB_TREAT_AS_TXT_BUTTON   "Treat as plain text"
...
#define D_WEB_ERR_MISSING_ID_FORMAT     "missing id/format"
#define D_WEB_ERR_BAD_FORMAT            "bad format"
#define D_WEB_ERR_FORMAT_FAILED         "format change failed"
